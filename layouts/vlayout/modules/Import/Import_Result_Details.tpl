 ...
 ********************************************************************************/
-->*}
{*<!--Added for import lead by Raghvender Singh on 17052014-->*}
{if $FOR_MODULE eq 'Leads'}
<table cellpadding="5" cellspacing="0" align="center" width="100%" class="dvtSelectedCell thickBorder importContents">
	<tr>
		<td>Total Records </td>
		<td width="10%">:</td>
		<td width="30%">{$numberOfRecordsRead}</td>
	</tr>
	{if in_array($FOR_MODULE, $INVENTORY_MODULES) eq FALSE}
		<tr>
			<td>Records Successfully Imported</td>
			<td width="10%">:</td>
			<td width="30%">{$imported_records}
			</td>
		</tr>
	{/if}
   <tr>
		<td>Records Successfully Updated</td>
		<td width="10%">:</td>
		<td>{$updated_records}</td>
	</tr>
	<tr>
		<td>Records Skipped</td>
		<td width="10%">:</td>
		<td>{$skipped_records}</td>
        <td ><a href="download_import_file.php?file={$file_path}">Click To Download Skiped Leads</a></td>
	</tr>
</table>
{*<!--End Added for import lead by Raghvender Singh on 17052014-->*}
{else}
<table cellpadding="5" cellspacing="0" align="center" width="100%" class="dvtSelectedCell thickBorder importContents">
	<tr>
