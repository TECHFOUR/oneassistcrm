				...
				<div class="span12">
					<div class="content-wrapper">
						<div class="container-fluid">
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container" style="margin-top:140px;"><img src="layouts/vlayout/skins/images/New Logo.png">
								...
								<div class="span6">
									<div class="login-area" style="color:#FBDC0F">
										<div class="login-box" id="loginDiv" style="background: #4A4A4A">
											<div class="">
												<h3 class="login-header" ><span style="color:#FFF">Login to</span> <span style="color:#33B450; font-size:30px; font-family:sa !important;">O</span><span style="color:#33B450; font-size:21px; font-family:sa;">NE</span><span style="color:#33B450; font-size:30px; font-family:sa !important;">A</span><span style="color:#33B450; font-size:21px; font-family:sa;">SSIST</span> <span style="color:#FFF"> CRM</span></h3>
											</div>
											<form class="form-horizontal login-form" style="margin:0;" action="index.php?module=Users&action=Login" method="POST">
												...
												<div class="control-group">
													<label class="control-label" for="username" style="color:#33B450"><b>User name</b></label>
													<div class="controls">
												...
												<div class="control-group">
													<label class="control-label" for="password" style="color:#33B450"><b>Password</b></label>
													<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="forgotPassword">
														<button type="submit"  style="background-color: #33B450; border-color:#33B450">Sign in</button>
														&nbsp;&nbsp;&nbsp;
                                                       <!-- <a>Forgot Password ?</a>-->
													</div>
												</div>
