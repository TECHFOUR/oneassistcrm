...
<div  class="summaryWidgetContainer">
	<div class="widget_header row-fluid">
        ...
        {if $MODULE eq 'Leads'&& $CURRENTURL eq $CREATEDURL}
                {*<!-- <span class="span4"><a class="btn pull-right addButton" href="index.php?module=Calendar&view=Edit&mode=Events" type="button"><strong>{vtranslate('LBL_ADD',$MODULE_NAME)}</strong></a></span>-->*}
        {else}
