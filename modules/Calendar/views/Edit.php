...
Class Calendar_Edit_View extends Vtiger_Edit_View {
	...
	function Events($request, $moduleName) {
		...
		//Add by Raghvender Singh on 13052014 for left panel Customer information in Event add time	
		$requestModuleName = $_REQUEST['module'];
		global $adb,$current_user;
        // For Customer details
   		if($requestModuleName == 'Calendar' || $requestModuleName == 'Events'){
			...
			WHERE vtiger_leaddetails.leadid = ".$_SESSION['recordid']);
			}
	    ...
	    if($adb->num_rows($contact_qry) > 0) {
			...
			//End Add by Raghvender Singh on 13052014 for left panel Customer information in Event add time
