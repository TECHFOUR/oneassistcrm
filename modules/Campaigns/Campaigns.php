...
class Campaigns extends CRMEntity {
	...
	var $list_fields = Array(
					'Campaign No'=>Array('campaign'=>'campaign_no'),
					'Campaign Name'=>Array('campaign'=>'campaignname'),
					'Campaign Location'=>Array('campaign'=>'sponsor'),
					'Campaign Start Date'=>Array('campaign'=>'closingdate'),
					'Campaign End Date'=>Array('campaigncf'=>'cf_703'),
	...
	var $list_fields_name = Array(
					...
					'Campaign Location'=>'sponsor',
					'Campaign Start Date'=>'closingdate',
					'Campaign End Date'=>'cf_703',
