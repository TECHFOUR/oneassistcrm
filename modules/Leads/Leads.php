...
class Leads extends CRMEntity {
	...
	*/
	function save_module($module)
	{
        ...
        if($this->mode != "edit" ) {
            $this->createNewActivity($current_user->id, $assignedid, $this->id, $leadactivitystartdate);
        }
	}

    function createNewActivity($currentuser, $new_assigned_to, $lead_id, $leadactivitystartdate) {
        ...
        $activity_qry = $adb->query("SELECT vtiger_activitycf.*, smownerid, leadsource FROM vtiger_leaddetails
